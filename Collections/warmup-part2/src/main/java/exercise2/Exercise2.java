 ...
 *              For this exercise you need to follow in order, all the  steps.
 */
public class Exercise2 {
    ...
    public void addStudents(){
        ...
        System.out.println("The set of students is: " + studentSetWithoutEqualsAndHashCode.toString());
        System.out.println("The map of students is: " + studentMapWithoutEqualsAndHashCode.toString());
