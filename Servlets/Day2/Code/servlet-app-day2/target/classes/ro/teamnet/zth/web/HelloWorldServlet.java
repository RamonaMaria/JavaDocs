...
public class HelloWorldServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("/HelloWorldServletForward");
        request.setAttribute("testAttribute", "Enjoy ZH2");
        requestDispatcher.include(request, response);
        response.getWriter().write("First ceva");
        requestDispatcher.forward(request, response);
        response.getWriter().write("Second ceva");
