...
<script type="text/javascript">
    function exportFile() {
        ...
        if (username != null && username != "") {
            ...
            // and the following request parameters: template, fileType and username
            // TIP: template = UsernameReport, fileType = pdf
            // TIP: Remember that the application context it's named servlet-app
            window.open("servlet-app-day2/export?user=" + username + "&fileType=" + fileType + "&template=" + template);
        } else {
            ...
            // TIP: Remember that the application context it's named servlet-app
            window.open("servlet-app-day2/export?fileType=" + fileType + "&template=" + template);
        }
